...
public class ClockBlockTileEntityRenderer extends TileEntitySpecialRenderer {
    private static final ResourceLocation texture = new ResourceLocation("talecraft:textures/blocks/util/timer.png");
	...
	public void renderTileEntityAt(TileEntity p_180535_1_, double posX, double posY, double posZ, float p_180535_8_, int p_180535_9_) {
		ClockBlockTileEntity tile = (ClockBlockTileEntity) p_180535_1_;
